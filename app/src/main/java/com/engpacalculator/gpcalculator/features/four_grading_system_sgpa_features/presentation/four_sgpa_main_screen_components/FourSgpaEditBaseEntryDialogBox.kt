                        ...
                        onValueChange = {
                            if (it.length <= state.maxNoOfCoursesLength) {
                                ...
                                if (state.enteredCourses != "0") {
                                    events(FourGpaUiEvents.setTotalNumberOfEditedCourses(state.enteredCourses))
                                    events(FourGpaUiEvents.setTotalCourses(state.enteredCourses))

                                } else if (state.enteredCourses == "0") {
                                    events(FourGpaUiEvents.setTotalNumberOfEditedCourses(state.prevTotalNumberOfCourses))
                                    events(FourGpaUiEvents.setTotalCourses(state.prevTotalNumberOfCourses))

                                } else {
                                    events(FourGpaUiEvents.setTotalNumberOfEditedCourses(state.totalCourses))
