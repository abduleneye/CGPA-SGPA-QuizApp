...
@Composable
fun QuizIntroDialogBoxFromDatatStore(
                    ...
                    item {
                        Text(
                            text = "Welcome! to the quiz section of " +
                                    ...
                                    "app or from play store " +
                                    "or you will be notified with instructions " +
                                    "on how to update the app from a different app store " +
